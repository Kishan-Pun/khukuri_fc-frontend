...
import Contacttableinfo from '../../components/Table/Contacttable/Contacttableinfo';
    ...
    const fetchData = async () => {
      try {
        const responseData = await sendRequest(
          "http://localhost:5000/api/admin/contactstable"
        );
  ...
  return (
    <React.Fragment>
      ...
      {!isLoading && loadedContact && (
         <Contacttableinfo items={loadedContact} />
        )}
